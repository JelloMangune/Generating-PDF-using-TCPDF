...
$pdf->PrintChapter(1, 'Heir to the Empire', '../resources/texts/starwars-chapter1.txt', false);

$pdf->PrintChapter(2, 'Dark Force Rising', '../resources/texts/starwars-chapter2.txt', true);

$pdf->PrintChapter(3, 'The Last Command', '../resources/texts/starwars-chapter3.txt', true);

$pdf->Output('starwars.pdf', 'I');
