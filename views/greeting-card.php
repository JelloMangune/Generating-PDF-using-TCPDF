...
// set bacground image
$img_file = '../resources/images/christmas.jpg';
...
$pdf->Cell(230, 70, 'Merry Christmas!', 0, 0, 'C', 0, '', 0);
$pdf->SetFont('times', 'I', 40, '', false);
$pdf->Ln(0);
$pdf->Cell(50, 110, '                       ---- and ----', 0, 0, 'L', 0, '', 0);
$pdf->Ln(0);
$pdf->SetFont('times', 'BI', 60, '', false);
$pdf->Cell(230, 145, 'Happy New Year!', 0, 0, 'C', 0, '', 0);
$pdf->SetLineStyle($style5);
$pdf->Ln(0);
$html = '<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><span style="text-align:justify;"><p>Warmest thoughts and best wishes for a wonderful Christmas and a Happy New Year.</p></span>';
